...
import { THROW_CHANNEL, THROW_TYPE_TOTAL, THROW_STATUS,THROW_PLATFORM } from '@/utils/enum';
...
export function columnsFn(props) {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'putStatus',
            render: (text) => {
                return getOptionName(THROW_STATUS, text);
            }
        },
        {
            title: '投放金额',
                ...
                return (
                    <div>
                        ...
                        <AuthButton authority="/foreEnd/business/talentManage/throwManage/detail">
                            <span className={styles.btnCls}  onClick={() => props.checkData(record.id)}> 查看</span>
                        </AuthButton>
                    </div>
                );
            },
