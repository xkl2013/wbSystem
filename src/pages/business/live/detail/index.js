...
export default class Detail extends React.Component {
    ...
    showModal = async ({ tableId, rowId, rowData, filterCols }) => {
        ...
        if (!rowId) {
            ...
            if (res && res.success) {
                await this.setState({
                    visible: true, tableId, rowId, rowData: [], data: [], detailType: 'detailPage',
                });
    ...
    getInstanceDetail = async ({ rowId, tableId }) => {
        ...
        if (response && response.success) {
            ...
            const noEditAuth = this.hideEditBtn(data);
            this.setState({
                rowData,
                data: helperData,
                tableId,
                ...
                detailType: noEditAuth ? 'detailPage' : 'editPage',
            });
        }
    };
    ...
    hideEditBtn = (data) => {
        ...
        return noEdit || customCheckLocked(data || detailData);
    };
