...
export const emitChangeCell4Msg = async ({ rowId, value }) => {
    const { tableId, addOrUpdateDataSource } = businessConfig[39];
...
export const formatColumns = (columns) => {
    const config = businessConfig[39];
    ...
    return (
        <>
            <ApolloTable
                ...
                cellEditable={checkPathname('/foreEnd/business/live/session/first/edit')}
                ...
                operateConfig={{
                    ...
                    buttonsGroup: [
                        ...
                        {
                            hidden: !checkPathname('/foreEnd/business/live/session/first/export'),
                            render: () => (
                                <ExportTable
                                    liveId={liveId}
                                    tableId={tableId}
                        ...
                        },
                        {
                            label: '删除',
                            type: 'primary',
                            hidden: !checkPathname('/foreEnd/business/live/session/first/del'),
                            onClick: onClickDelLines,
                        },
                        {
                            label: '移至',
                            type: 'primary',
                            hidden: !checkPathname('/foreEnd/business/live/session/first/transfer'),
            ...
            <HistoryDetail
                ...
                formatColumns={formatColumns}
                noAdd={!checkPathname('/foreEnd/business/live/session/first/history/add')}
                noEdit={!checkPathname('/foreEnd/business/live/session/first/history/edit')}
                noDel={!checkPathname('/foreEnd/business/live/session/first/history/del')}
            />
            <TransferProduct
