    ...
    return (
        <>
            <ApolloTable
                ...
                cellEditable={checkPathname('/foreEnd/business/recruit/edit2')}
                    ...
                    buttonsGroup: [
                        {
                            label: '删除',
                            type: 'primary',
                            hidden: !checkPathname('/foreEnd/business/recruit/del2'),
                            onClick: onClickDelLines,
                        },
                        {
                            label: '移至',
                            type: 'primary',
                            hidden: !checkPathname('/foreEnd/business/recruit/move2'),
