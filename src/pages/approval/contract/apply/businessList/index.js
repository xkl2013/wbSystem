...
@connect(({ admin_approval, loading }) => {
    return {
        commerceApplyBusinessLists: admin_approval.commerceApplyBusinessLists,
        loading: loading.effects['admin_approval/getApplyCommerceBusinessLists'],
    };
})
// 合同审核申请列表 - 商单审核
class BusinessVerify extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            // pageDataLists: [],
    ...
    fetchData = (beforeFetch) => {
        ...
        this.props.dispatch({
            type: 'admin_approval/getApplyCommerceBusinessLists',
    ...
    checkData = (val) => {
        ...
        this.props.history.push({
            pathname:
                localUrl === '/foreEnd/approval/approval/business' || localUrl === '/foreEnd/approval/apply/business'
                    ? './business/detail'
                    : '../../business/project/verify/detail',
            query: {
                id: val,
            },
        });
    ...
    render() {
        const { commerceApplyBusinessLists } = this.props;
        ...
        return (
            <>
                <PageDataView
                    ...
                    searchCols={
                        localUrl === '/foreEnd/business/project/verify'
                            ? [
                                [
                                    {
                    ...
                    cols={columnsFn(this)}
                    scroll={{ x: 1500 }}
                    pageData={{ ...commerceApplyBusinessLists }}
                    pagination={{
