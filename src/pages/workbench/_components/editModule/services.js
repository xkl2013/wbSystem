...
export async function addSchedule(data) {
    return request('/panel/schedule/add', { method: 'post', data, prefix: '/crmApi' });
}
// 编辑
...
// 查询任务标签列表
export async function getScheduleTags(params) {
    return request('/schedule/tags/search', { prefix: '/crmApi', params, method: 'get' });
}
// 修改任务标签
